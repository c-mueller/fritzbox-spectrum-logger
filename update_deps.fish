...
echo "// Fritz!Box Spectrum Logger (https://github.com/c-mueller/fritzbox-spectrum-logger)." > dep_info.go
echo "// Copyright (c) 2018 Christian Müller <cmueller.dev@gmail.com>." >> dep_info.go
echo "//" >> dep_info.go
